...
컨테이너: `max-w-page mx-auto` (1200px). 무신사 상품 카드 이미지 비율은 **3:4** (세로형). PRD 의 `grid-cols-1 sm:grid-cols-2 lg:grid-cols-3` 은 이 표로 대체할 수 있으나, PRD 수용 기준(모바일 1열/데스크톱 3열)을 바꾸려면 PRD 를 먼저 수정한다.
